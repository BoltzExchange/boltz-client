...
func uniffiCheckChecksums() {
	...
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_bdk_checksum_method_wallet_address()
		})
		if checksum != 11550 {
			// If this happens try cleaning and rebuilding your project
			panic("bdk: uniffi_bdk_checksum_method_wallet_address: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
...
func NewBackend(network Network, electrumUrl string, dbPath string) (*Backend, error) {
	_uniffiRV, _uniffiErr := rustCallWithError[Error](FfiConverterError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_bdk_fn_constructor_backend_new(FfiConverterNetworkINSTANCE.Lower(network), FfiConverterStringINSTANCE.Lower(electrumUrl), FfiConverterStringINSTANCE.Lower(dbPath), _uniffiStatus)
	})
	if _uniffiErr != nil {
...
func NewWallet(backend *Backend, credentials WalletCredentials) (*Wallet, error) {
	_uniffiRV, _uniffiErr := rustCallWithError[Error](FfiConverterError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_bdk_fn_constructor_wallet_new(FfiConverterBackendINSTANCE.Lower(backend), FfiConverterWalletCredentialsINSTANCE.Lower(credentials), _uniffiStatus)
	})
	if _uniffiErr != nil {
...
func (_self *Wallet) Address() (string, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError[Error](FfiConverterError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return GoRustBuffer{
			inner: C.uniffi_bdk_fn_method_wallet_address(
...
type WalletCredentials interface {
	Destroy()
}
type WalletCredentialsMnemonic struct {
	Field0 string
}

func (e WalletCredentialsMnemonic) Destroy() {
	FfiDestroyerString{}.Destroy(e.Field0)
}

type WalletCredentialsCoreDescriptor struct {
	Field0 string
}

func (e WalletCredentialsCoreDescriptor) Destroy() {
	FfiDestroyerString{}.Destroy(e.Field0)
}
...
func (FfiConverterWalletCredentials) Read(reader io.Reader) WalletCredentials {
	id := readInt32(reader)
	switch id {
	case 1:
		return WalletCredentialsMnemonic{
			FfiConverterStringINSTANCE.Read(reader),
		}
	case 2:
		return WalletCredentialsCoreDescriptor{
			FfiConverterStringINSTANCE.Read(reader),
		}
	default:
		panic(fmt.Sprintf("invalid enum value %v in FfiConverterWalletCredentials.Read()", id))
	}
}

func (FfiConverterWalletCredentials) Write(writer io.Writer, value WalletCredentials) {
	switch variant_value := value.(type) {
	case WalletCredentialsMnemonic:
		writeInt32(writer, 1)
		FfiConverterStringINSTANCE.Write(writer, variant_value.Field0)
	case WalletCredentialsCoreDescriptor:
		writeInt32(writer, 2)
		FfiConverterStringINSTANCE.Write(writer, variant_value.Field0)
	default:
		_ = variant_value
		panic(fmt.Sprintf("invalid enum value `%v` in FfiConverterWalletCredentials.Write", value))
	}
}
