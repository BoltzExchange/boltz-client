...
func uniffiCheckChecksums() {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_lwk_checksum_method_invoiceresponse_lockup_txid()
		})
		if checksum != 35108 {
			// If this happens try cleaning and rebuilding your project
			panic("lwk: uniffi_lwk_checksum_method_invoiceresponse_lockup_txid: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_lwk_checksum_method_lockupresponse_claim_address()
		})
		if checksum != 49213 {
			// If this happens try cleaning and rebuilding your project
			panic("lwk: uniffi_lwk_checksum_method_lockupresponse_claim_address: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_lwk_checksum_method_lockupresponse_refund_txid()
		})
		if checksum != 51703 {
			// If this happens try cleaning and rebuilding your project
			panic("lwk: uniffi_lwk_checksum_method_lockupresponse_refund_txid: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
	...
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_lwk_checksum_method_preparepayresponse_refund_txid()
		})
		if checksum != 35630 {
			// If this happens try cleaning and rebuilding your project
			panic("lwk: uniffi_lwk_checksum_method_preparepayresponse_refund_txid: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
...
// The txid of the lockup transaction of the swap (made by Boltz)
func (_self *InvoiceResponse) LockupTxid() (*string, error) {
	_pointer := _self.ffiObject.incrementPointer("*InvoiceResponse")
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError[LwkError](FfiConverterLwkError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return GoRustBuffer{
			inner: C.uniffi_lwk_fn_method_invoiceresponse_lockup_txid(
				_pointer, _uniffiStatus),
		}
	})
	if _uniffiErr != nil {
...
func (_self *LockupResponse) ClaimAddress() (string, error) {
	_pointer := _self.ffiObject.incrementPointer("*LockupResponse")
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError[LwkError](FfiConverterLwkError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return GoRustBuffer{
			inner: C.uniffi_lwk_fn_method_lockupresponse_claim_address(
				_pointer, _uniffiStatus),
		}
	})
	if _uniffiErr != nil {
...
// The txid of the refund transaction of the swap
func (_self *LockupResponse) RefundTxid() (*string, error) {
	_pointer := _self.ffiObject.incrementPointer("*LockupResponse")
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError[LwkError](FfiConverterLwkError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return GoRustBuffer{
			inner: C.uniffi_lwk_fn_method_lockupresponse_refund_txid(
				_pointer, _uniffiStatus),
		}
	})
	if _uniffiErr != nil {
...
// The txid of the refund transaction of the swap
func (_self *PreparePayResponse) RefundTxid() (*string, error) {
	_pointer := _self.ffiObject.incrementPointer("*PreparePayResponse")
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError[LwkError](FfiConverterLwkError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return GoRustBuffer{
			inner: C.uniffi_lwk_fn_method_preparepayresponse_refund_txid(
				_pointer, _uniffiStatus),
		}
	})
	if _uniffiErr != nil {
