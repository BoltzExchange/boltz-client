...
func (_m *MockLightningNode) BumpTransactionFee(txId string, satPerVbyte float64) (string, error) {
...
func (_c *MockLightningNode_BumpTransactionFee_Call) Return(_a0 string, _a1 error) *MockLightningNode_BumpTransactionFee_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockLightningNode_BumpTransactionFee_Call) RunAndReturn(run func(string, float64) (string, error)) *MockLightningNode_BumpTransactionFee_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockLightningNode) GetTransactions(limit uint64, offset uint64) ([]*onchain.WalletTransaction, error) {
...
func (_c *MockLightningNode_GetTransactions_Call) Return(_a0 []*onchain.WalletTransaction, _a1 error) *MockLightningNode_GetTransactions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockLightningNode_GetTransactions_Call) RunAndReturn(run func(uint64, uint64) ([]*onchain.WalletTransaction, error)) *MockLightningNode_GetTransactions_Call {
	_c.Call.Return(run)
	return _c
}
