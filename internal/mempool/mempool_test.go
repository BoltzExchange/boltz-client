...
func TestGetTx(t *testing.T) {
	...
	hex, err := mc.GetRawTransaction("c95157dc89ea9b531c4bd40e51ced2e1f4910b770c5e0e090d40b93e47ff95fd")
	require.NoError(t, err)
...
func TestOnchainGetFee(t *testing.T) {
	...
	tx, err := boltz.NewTxFromHex(boltz.CurrencyBtc, "", nil)
	require.NoError(t, err)

	fee, err := onchain.GetTransactionFee(boltz.CurrencyBtc, tx.Hash())
	require.NoError(t, err)
