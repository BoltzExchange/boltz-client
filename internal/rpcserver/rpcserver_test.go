...
func TestBumpTransaction(t *testing.T) {
	...
	t.Run("TxId", func(t *testing.T) {
		...
		for _, tc := range tests {
			t.Run(tc.desc, func(t *testing.T) {
				tc.setup(t)
				_, err := client.BumpTransaction(request)
				if tc.wantErr != "" {
					require.Error(t, err)
	...
	t.Run("SwapId", func(t *testing.T) {
		...
		tests := []struct {
		...
		}{
			{
				...
				setup: func(t *testing.T) {
					request.Previous = &boltzrpc.BumpTransactionRequest_SwapId{SwapId: normalSwap}
	...
	for _, tc := range tests {
		t.Run(tc.desc, func(t *testing.T) {
			...
			t.Run("InternalWallets", func(t *testing.T) {
				t.Run("EnoughBalance", func(t *testing.T) {
					toWallet, err := client.GetWalletById(toWallet.Id)
					require.NoError(t, err)
					...
					t.Run("Manual", func(t *testing.T) {
						...
						t.Run("Wallet", func(t *testing.T) {
							...
							t.Run("Valid", func(t *testing.T) {
								...
								fromWallet, err := client.GetWalletById(fromWallet.Id)
								require.NoError(t, err)
								require.NotZero(t, fromWallet.Balance.Unconfirmed)
