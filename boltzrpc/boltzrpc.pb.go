...
var file_boltzrpc_proto_rawDesc = []byte{
	...
	0x05, 0x2a, 0x1f, 0x0a, 0x08, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x07, 0x0a,
	0x03, 0x42, 0x74, 0x63, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64,
	0x10, 0x01, 0x32, 0x8b, 0x0e, 0x0a, 0x05, 0x42, 0x6f, 0x6c, 0x74, 0x7a, 0x12, 0x3e, 0x0a, 0x07,
	...
	0x2e, 0x52, 0x65, 0x76, 0x65, 0x72, 0x73, 0x65, 0x50, 0x61, 0x69, 0x72, 0x12, 0x59, 0x0a, 0x10,
...
var file_boltzrpc_proto_depIdxs = []int32{
	...
	13, // 18: boltzrpc.Fees.miner:type_name -> boltzrpc.MinerFees
	14, // 19: boltzrpc.GetServiceInfoResponse.fees:type_name -> boltzrpc.Fees
	9,  // 20: boltzrpc.GetServiceInfoResponse.limits:type_name -> boltzrpc.Limits
	2,  // 21: boltzrpc.GetFeeEstimationRequest.pair:type_name -> boltzrpc.Pair
	14, // 22: boltzrpc.GetFeeEstimationResponse.fees:type_name -> boltzrpc.Fees
	9,  // 23: boltzrpc.GetFeeEstimationResponse.limits:type_name -> boltzrpc.Limits
	1,  // 24: boltzrpc.ListSwapsRequest.from:type_name -> boltzrpc.Currency
	1,  // 25: boltzrpc.ListSwapsRequest.to:type_name -> boltzrpc.Currency
	...
	30, // 35: boltzrpc.LightningChannel.id:type_name -> boltzrpc.ChannelId
	31, // 36: boltzrpc.SwapRecommendation.channel:type_name -> boltzrpc.LightningChannel
	32, // 37: boltzrpc.GetSwapRecommendationsResponse.swaps:type_name -> boltzrpc.SwapRecommendation
	37, // 38: boltzrpc.ImportWalletRequest.credentials:type_name -> boltzrpc.WalletCredentials
	38, // 39: boltzrpc.ImportWalletRequest.info:type_name -> boltzrpc.WalletInfo
	38, // 40: boltzrpc.CreateWalletRequest.info:type_name -> boltzrpc.WalletInfo
	53, // 41: boltzrpc.GetSubaccountsResponse.subaccounts:type_name -> boltzrpc.Subaccount
	51, // 42: boltzrpc.Wallet.balance:type_name -> boltzrpc.Balance
	49, // 43: boltzrpc.Wallets.wallets:type_name -> boltzrpc.Wallet
	51, // 44: boltzrpc.Account.balance:type_name -> boltzrpc.Balance
	51, // 45: boltzrpc.Subaccount.balance:type_name -> boltzrpc.Balance
	62, // 46: boltzrpc.ReversePair.Fees.miner_fees:type_name -> boltzrpc.ReversePair.Fees.MinerFees
	7,  // 47: boltzrpc.Boltz.GetInfo:input_type -> boltzrpc.GetInfoRequest
	15, // 48: boltzrpc.Boltz.GetServiceInfo:input_type -> boltzrpc.GetServiceInfoRequest
	2,  // 49: boltzrpc.Boltz.GetSubmarinePair:input_type -> boltzrpc.Pair
	2,  // 50: boltzrpc.Boltz.GetReversePair:input_type -> boltzrpc.Pair
	17, // 51: boltzrpc.Boltz.GetFeeEstimation:input_type -> boltzrpc.GetFeeEstimationRequest
	19, // 52: boltzrpc.Boltz.ListSwaps:input_type -> boltzrpc.ListSwapsRequest
	21, // 53: boltzrpc.Boltz.GetSwapInfo:input_type -> boltzrpc.GetSwapInfoRequest
	21, // 54: boltzrpc.Boltz.GetSwapInfoStream:input_type -> boltzrpc.GetSwapInfoRequest
	23, // 55: boltzrpc.Boltz.Deposit:input_type -> boltzrpc.DepositRequest
	25, // 56: boltzrpc.Boltz.CreateSwap:input_type -> boltzrpc.CreateSwapRequest
	27, // 57: boltzrpc.Boltz.CreateChannel:input_type -> boltzrpc.CreateChannelRequest
	28, // 58: boltzrpc.Boltz.CreateReverseSwap:input_type -> boltzrpc.CreateReverseSwapRequest
	40, // 59: boltzrpc.Boltz.CreateWallet:input_type -> boltzrpc.CreateWalletRequest
	39, // 60: boltzrpc.Boltz.ImportWallet:input_type -> boltzrpc.ImportWalletRequest
	41, // 61: boltzrpc.Boltz.SetSubaccount:input_type -> boltzrpc.SetSubaccountRequest
	38, // 62: boltzrpc.Boltz.GetSubaccounts:input_type -> boltzrpc.WalletInfo
	45, // 63: boltzrpc.Boltz.GetWallets:input_type -> boltzrpc.GetWalletsRequest
	46, // 64: boltzrpc.Boltz.GetWallet:input_type -> boltzrpc.GetWalletRequest
	47, // 65: boltzrpc.Boltz.GetWalletCredentials:input_type -> boltzrpc.GetWalletCredentialsRequest
	48, // 66: boltzrpc.Boltz.RemoveWallet:input_type -> boltzrpc.RemoveWalletRequest
	63, // 67: boltzrpc.Boltz.Stop:input_type -> google.protobuf.Empty
	55, // 68: boltzrpc.Boltz.Unlock:input_type -> boltzrpc.UnlockRequest
	56, // 69: boltzrpc.Boltz.VerifyWalletPassword:input_type -> boltzrpc.VerifyWalletPasswordRequest
	58, // 70: boltzrpc.Boltz.ChangeWalletPassword:input_type -> boltzrpc.ChangeWalletPasswordRequest
	8,  // 71: boltzrpc.Boltz.GetInfo:output_type -> boltzrpc.GetInfoResponse
	16, // 72: boltzrpc.Boltz.GetServiceInfo:output_type -> boltzrpc.GetServiceInfoResponse
	10, // 73: boltzrpc.Boltz.GetSubmarinePair:output_type -> boltzrpc.SubmarinePair
	11, // 74: boltzrpc.Boltz.GetReversePair:output_type -> boltzrpc.ReversePair
	18, // 75: boltzrpc.Boltz.GetFeeEstimation:output_type -> boltzrpc.GetFeeEstimationResponse
	20, // 76: boltzrpc.Boltz.ListSwaps:output_type -> boltzrpc.ListSwapsResponse
	...
	37, // 83: boltzrpc.Boltz.CreateWallet:output_type -> boltzrpc.WalletCredentials
	49, // 84: boltzrpc.Boltz.ImportWallet:output_type -> boltzrpc.Wallet
	53, // 85: boltzrpc.Boltz.SetSubaccount:output_type -> boltzrpc.Subaccount
	43, // 86: boltzrpc.Boltz.GetSubaccounts:output_type -> boltzrpc.GetSubaccountsResponse
	50, // 87: boltzrpc.Boltz.GetWallets:output_type -> boltzrpc.Wallets
	49, // 88: boltzrpc.Boltz.GetWallet:output_type -> boltzrpc.Wallet
	37, // 89: boltzrpc.Boltz.GetWalletCredentials:output_type -> boltzrpc.WalletCredentials
	54, // 90: boltzrpc.Boltz.RemoveWallet:output_type -> boltzrpc.RemoveWalletResponse
	63, // 91: boltzrpc.Boltz.Stop:output_type -> google.protobuf.Empty
	63, // 92: boltzrpc.Boltz.Unlock:output_type -> google.protobuf.Empty
	57, // 93: boltzrpc.Boltz.VerifyWalletPassword:output_type -> boltzrpc.VerifyWalletPasswordResponse
	63, // 94: boltzrpc.Boltz.ChangeWalletPassword:output_type -> google.protobuf.Empty
