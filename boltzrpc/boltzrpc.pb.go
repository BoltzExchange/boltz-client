...
var file_boltzrpc_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x64, 0x22, 0x5b,
	...
	0x69, 0x64, 0x22, 0x90, 0x01, 0x0a, 0x11, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x53, 0x65, 0x6e,
	...
	0x76, 0x62, 0x79, 0x74, 0x65, 0x22, 0x29, 0x0a, 0x12, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x53,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x65, 0x64, 0x22, 0x67, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x61,
	...
	0x65, 0x22, 0x16, 0x0a, 0x14, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x57, 0x61, 0x6c, 0x6c, 0x65,
	...
	0x12, 0x08, 0x0a, 0x04, 0x41, 0x55, 0x54, 0x4f, 0x10, 0x02, 0x32, 0x9f, 0x13, 0x0a, 0x05, 0x42,
	...
	0x6f, 0x6c, 0x74, 0x7a, 0x72, 0x70, 0x63, 0x2e, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x12, 0x5a,
...
var file_boltzrpc_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_boltzrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_boltzrpc_proto_goTypes = []interface{}{
	...
	(*CreateTenantRequest)(nil),          // 5: boltzrpc.CreateTenantRequest
	(*ListTenantsRequest)(nil),           // 6: boltzrpc.ListTenantsRequest
	(*ListTenantsResponse)(nil),          // 7: boltzrpc.ListTenantsResponse
	(*GetTenantRequest)(nil),             // 8: boltzrpc.GetTenantRequest
	(*Tenant)(nil),                       // 9: boltzrpc.Tenant
	(*MacaroonPermissions)(nil),          // 10: boltzrpc.MacaroonPermissions
	(*BakeMacaroonRequest)(nil),          // 11: boltzrpc.BakeMacaroonRequest
	(*BakeMacaroonResponse)(nil),         // 12: boltzrpc.BakeMacaroonResponse
	(*Pair)(nil),                         // 13: boltzrpc.Pair
	(*SwapInfo)(nil),                     // 14: boltzrpc.SwapInfo
	(*GetPairInfoRequest)(nil),           // 15: boltzrpc.GetPairInfoRequest
	(*PairInfo)(nil),                     // 16: boltzrpc.PairInfo
	(*ChannelCreationInfo)(nil),          // 17: boltzrpc.ChannelCreationInfo
	(*CombinedChannelSwapInfo)(nil),      // 18: boltzrpc.CombinedChannelSwapInfo
	(*ReverseSwapInfo)(nil),              // 19: boltzrpc.ReverseSwapInfo
	(*BlockHeights)(nil),                 // 20: boltzrpc.BlockHeights
	(*GetInfoRequest)(nil),               // 21: boltzrpc.GetInfoRequest
	(*GetInfoResponse)(nil),              // 22: boltzrpc.GetInfoResponse
	(*Limits)(nil),                       // 23: boltzrpc.Limits
	(*SwapFees)(nil),                     // 24: boltzrpc.SwapFees
	(*GetPairsResponse)(nil),             // 25: boltzrpc.GetPairsResponse
	(*MinerFees)(nil),                    // 26: boltzrpc.MinerFees
	(*Fees)(nil),                         // 27: boltzrpc.Fees
	(*GetServiceInfoRequest)(nil),        // 28: boltzrpc.GetServiceInfoRequest
	(*GetServiceInfoResponse)(nil),       // 29: boltzrpc.GetServiceInfoResponse
	(*AnySwapInfo)(nil),                  // 30: boltzrpc.AnySwapInfo
	(*ListSwapsRequest)(nil),             // 31: boltzrpc.ListSwapsRequest
	(*ListSwapsResponse)(nil),            // 32: boltzrpc.ListSwapsResponse
	(*GetStatsRequest)(nil),              // 33: boltzrpc.GetStatsRequest
	(*GetStatsResponse)(nil),             // 34: boltzrpc.GetStatsResponse
	(*RefundSwapRequest)(nil),            // 35: boltzrpc.RefundSwapRequest
	(*ClaimSwapsRequest)(nil),            // 36: boltzrpc.ClaimSwapsRequest
	(*ClaimSwapsResponse)(nil),           // 37: boltzrpc.ClaimSwapsResponse
	(*GetSwapInfoRequest)(nil),           // 38: boltzrpc.GetSwapInfoRequest
	(*GetSwapInfoResponse)(nil),          // 39: boltzrpc.GetSwapInfoResponse
	(*DepositRequest)(nil),               // 40: boltzrpc.DepositRequest
	(*DepositResponse)(nil),              // 41: boltzrpc.DepositResponse
	(*CreateSwapRequest)(nil),            // 42: boltzrpc.CreateSwapRequest
	(*CreateSwapResponse)(nil),           // 43: boltzrpc.CreateSwapResponse
	(*CreateChannelRequest)(nil),         // 44: boltzrpc.CreateChannelRequest
	(*CreateReverseSwapRequest)(nil),     // 45: boltzrpc.CreateReverseSwapRequest
	(*CreateReverseSwapResponse)(nil),    // 46: boltzrpc.CreateReverseSwapResponse
	(*CreateChainSwapRequest)(nil),       // 47: boltzrpc.CreateChainSwapRequest
	(*ChainSwapInfo)(nil),                // 48: boltzrpc.ChainSwapInfo
	(*ChainSwapData)(nil),                // 49: boltzrpc.ChainSwapData
	(*ChannelId)(nil),                    // 50: boltzrpc.ChannelId
	(*LightningChannel)(nil),             // 51: boltzrpc.LightningChannel
	(*SwapStats)(nil),                    // 52: boltzrpc.SwapStats
	(*Budget)(nil),                       // 53: boltzrpc.Budget
	(*WalletCredentials)(nil),            // 54: boltzrpc.WalletCredentials
	(*WalletParams)(nil),                 // 55: boltzrpc.WalletParams
	(*ImportWalletRequest)(nil),          // 56: boltzrpc.ImportWalletRequest
	(*CreateWalletRequest)(nil),          // 57: boltzrpc.CreateWalletRequest
	(*CreateWalletResponse)(nil),         // 58: boltzrpc.CreateWalletResponse
	(*SetSubaccountRequest)(nil),         // 59: boltzrpc.SetSubaccountRequest
	(*GetSubaccountsRequest)(nil),        // 60: boltzrpc.GetSubaccountsRequest
	(*GetSubaccountsResponse)(nil),       // 61: boltzrpc.GetSubaccountsResponse
	(*ImportWalletResponse)(nil),         // 62: boltzrpc.ImportWalletResponse
	(*GetWalletsRequest)(nil),            // 63: boltzrpc.GetWalletsRequest
	(*GetWalletRequest)(nil),             // 64: boltzrpc.GetWalletRequest
	(*GetWalletCredentialsRequest)(nil),  // 65: boltzrpc.GetWalletCredentialsRequest
	(*RemoveWalletRequest)(nil),          // 66: boltzrpc.RemoveWalletRequest
	(*WalletSendRequest)(nil),            // 67: boltzrpc.WalletSendRequest
	(*WalletSendResponse)(nil),           // 68: boltzrpc.WalletSendResponse
	(*WalletReceiveRequest)(nil),         // 69: boltzrpc.WalletReceiveRequest
	(*WalletReceiveResponse)(nil),        // 70: boltzrpc.WalletReceiveResponse
	(*Wallet)(nil),                       // 71: boltzrpc.Wallet
	(*Wallets)(nil),                      // 72: boltzrpc.Wallets
	(*Balance)(nil),                      // 73: boltzrpc.Balance
	(*Subaccount)(nil),                   // 74: boltzrpc.Subaccount
	(*RemoveWalletResponse)(nil),         // 75: boltzrpc.RemoveWalletResponse
	(*UnlockRequest)(nil),                // 76: boltzrpc.UnlockRequest
	(*VerifyWalletPasswordRequest)(nil),  // 77: boltzrpc.VerifyWalletPasswordRequest
	(*VerifyWalletPasswordResponse)(nil), // 78: boltzrpc.VerifyWalletPasswordResponse
	(*ChangeWalletPasswordRequest)(nil),  // 79: boltzrpc.ChangeWalletPasswordRequest
	(*empty.Empty)(nil),                  // 80: google.protobuf.Empty
}
var file_boltzrpc_proto_depIdxs = []int32{
	9,  // 0: boltzrpc.ListTenantsResponse.tenants:type_name -> boltzrpc.Tenant
	0,  // 1: boltzrpc.MacaroonPermissions.action:type_name -> boltzrpc.MacaroonAction
	10, // 2: boltzrpc.BakeMacaroonRequest.permissions:type_name -> boltzrpc.MacaroonPermissions
	2,  // 3: boltzrpc.Pair.from:type_name -> boltzrpc.Currency
	2,  // 4: boltzrpc.Pair.to:type_name -> boltzrpc.Currency
	13, // 5: boltzrpc.SwapInfo.pair:type_name -> boltzrpc.Pair
	1,  // 6: boltzrpc.SwapInfo.state:type_name -> boltzrpc.SwapState
	50, // 7: boltzrpc.SwapInfo.chan_ids:type_name -> boltzrpc.ChannelId
	3,  // 8: boltzrpc.GetPairInfoRequest.type:type_name -> boltzrpc.SwapType
	13, // 9: boltzrpc.GetPairInfoRequest.pair:type_name -> boltzrpc.Pair
	13, // 10: boltzrpc.PairInfo.pair:type_name -> boltzrpc.Pair
	24, // 11: boltzrpc.PairInfo.fees:type_name -> boltzrpc.SwapFees
	23, // 12: boltzrpc.PairInfo.limits:type_name -> boltzrpc.Limits
	14, // 13: boltzrpc.CombinedChannelSwapInfo.swap:type_name -> boltzrpc.SwapInfo
	17, // 14: boltzrpc.CombinedChannelSwapInfo.channel_creation:type_name -> boltzrpc.ChannelCreationInfo
	1,  // 15: boltzrpc.ReverseSwapInfo.state:type_name -> boltzrpc.SwapState
	13, // 16: boltzrpc.ReverseSwapInfo.pair:type_name -> boltzrpc.Pair
	50, // 17: boltzrpc.ReverseSwapInfo.chan_ids:type_name -> boltzrpc.ChannelId
	20, // 18: boltzrpc.GetInfoResponse.block_heights:type_name -> boltzrpc.BlockHeights
	9,  // 19: boltzrpc.GetInfoResponse.tenant:type_name -> boltzrpc.Tenant
	16, // 20: boltzrpc.GetPairsResponse.submarine:type_name -> boltzrpc.PairInfo
	16, // 21: boltzrpc.GetPairsResponse.reverse:type_name -> boltzrpc.PairInfo
	16, // 22: boltzrpc.GetPairsResponse.chain:type_name -> boltzrpc.PairInfo
	26, // 23: boltzrpc.Fees.miner:type_name -> boltzrpc.MinerFees
	27, // 24: boltzrpc.GetServiceInfoResponse.fees:type_name -> boltzrpc.Fees
	23, // 25: boltzrpc.GetServiceInfoResponse.limits:type_name -> boltzrpc.Limits
	3,  // 26: boltzrpc.AnySwapInfo.type:type_name -> boltzrpc.SwapType
	13, // 27: boltzrpc.AnySwapInfo.pair:type_name -> boltzrpc.Pair
	...
	14, // 33: boltzrpc.ListSwapsResponse.swaps:type_name -> boltzrpc.SwapInfo
	18, // 34: boltzrpc.ListSwapsResponse.channel_creations:type_name -> boltzrpc.CombinedChannelSwapInfo
	19, // 35: boltzrpc.ListSwapsResponse.reverse_swaps:type_name -> boltzrpc.ReverseSwapInfo
	48, // 36: boltzrpc.ListSwapsResponse.chain_swaps:type_name -> boltzrpc.ChainSwapInfo
	30, // 37: boltzrpc.ListSwapsResponse.all_swaps:type_name -> boltzrpc.AnySwapInfo
	4,  // 38: boltzrpc.GetStatsRequest.include:type_name -> boltzrpc.IncludeSwaps
	52, // 39: boltzrpc.GetStatsResponse.stats:type_name -> boltzrpc.SwapStats
	14, // 40: boltzrpc.GetSwapInfoResponse.swap:type_name -> boltzrpc.SwapInfo
	17, // 41: boltzrpc.GetSwapInfoResponse.channel_creation:type_name -> boltzrpc.ChannelCreationInfo
	19, // 42: boltzrpc.GetSwapInfoResponse.reverse_swap:type_name -> boltzrpc.ReverseSwapInfo
	48, // 43: boltzrpc.GetSwapInfoResponse.chain_swap:type_name -> boltzrpc.ChainSwapInfo
	13, // 44: boltzrpc.CreateSwapRequest.pair:type_name -> boltzrpc.Pair
	13, // 45: boltzrpc.CreateReverseSwapRequest.pair:type_name -> boltzrpc.Pair
	13, // 46: boltzrpc.CreateChainSwapRequest.pair:type_name -> boltzrpc.Pair
	13, // 47: boltzrpc.ChainSwapInfo.pair:type_name -> boltzrpc.Pair
	1,  // 48: boltzrpc.ChainSwapInfo.state:type_name -> boltzrpc.SwapState
	49, // 49: boltzrpc.ChainSwapInfo.from_data:type_name -> boltzrpc.ChainSwapData
	49, // 50: boltzrpc.ChainSwapInfo.to_data:type_name -> boltzrpc.ChainSwapData
	2,  // 51: boltzrpc.ChainSwapData.currency:type_name -> boltzrpc.Currency
	50, // 52: boltzrpc.LightningChannel.id:type_name -> boltzrpc.ChannelId
	2,  // 53: boltzrpc.WalletParams.currency:type_name -> boltzrpc.Currency
	54, // 54: boltzrpc.ImportWalletRequest.credentials:type_name -> boltzrpc.WalletCredentials
	55, // 55: boltzrpc.ImportWalletRequest.params:type_name -> boltzrpc.WalletParams
	55, // 56: boltzrpc.CreateWalletRequest.params:type_name -> boltzrpc.WalletParams
	71, // 57: boltzrpc.CreateWalletResponse.wallet:type_name -> boltzrpc.Wallet
	74, // 58: boltzrpc.GetSubaccountsResponse.subaccounts:type_name -> boltzrpc.Subaccount
	2,  // 59: boltzrpc.GetWalletsRequest.currency:type_name -> boltzrpc.Currency
	2,  // 60: boltzrpc.Wallet.currency:type_name -> boltzrpc.Currency
	73, // 61: boltzrpc.Wallet.balance:type_name -> boltzrpc.Balance
	71, // 62: boltzrpc.Wallets.wallets:type_name -> boltzrpc.Wallet
	73, // 63: boltzrpc.Subaccount.balance:type_name -> boltzrpc.Balance
	21, // 64: boltzrpc.Boltz.GetInfo:input_type -> boltzrpc.GetInfoRequest
	28, // 65: boltzrpc.Boltz.GetServiceInfo:input_type -> boltzrpc.GetServiceInfoRequest
	15, // 66: boltzrpc.Boltz.GetPairInfo:input_type -> boltzrpc.GetPairInfoRequest
	80, // 67: boltzrpc.Boltz.GetPairs:input_type -> google.protobuf.Empty
	31, // 68: boltzrpc.Boltz.ListSwaps:input_type -> boltzrpc.ListSwapsRequest
	33, // 69: boltzrpc.Boltz.GetStats:input_type -> boltzrpc.GetStatsRequest
	35, // 70: boltzrpc.Boltz.RefundSwap:input_type -> boltzrpc.RefundSwapRequest
	36, // 71: boltzrpc.Boltz.ClaimSwaps:input_type -> boltzrpc.ClaimSwapsRequest
	38, // 72: boltzrpc.Boltz.GetSwapInfo:input_type -> boltzrpc.GetSwapInfoRequest
	38, // 73: boltzrpc.Boltz.GetSwapInfoStream:input_type -> boltzrpc.GetSwapInfoRequest
	40, // 74: boltzrpc.Boltz.Deposit:input_type -> boltzrpc.DepositRequest
	42, // 75: boltzrpc.Boltz.CreateSwap:input_type -> boltzrpc.CreateSwapRequest
	44, // 76: boltzrpc.Boltz.CreateChannel:input_type -> boltzrpc.CreateChannelRequest
	45, // 77: boltzrpc.Boltz.CreateReverseSwap:input_type -> boltzrpc.CreateReverseSwapRequest
	47, // 78: boltzrpc.Boltz.CreateChainSwap:input_type -> boltzrpc.CreateChainSwapRequest
	57, // 79: boltzrpc.Boltz.CreateWallet:input_type -> boltzrpc.CreateWalletRequest
	56, // 80: boltzrpc.Boltz.ImportWallet:input_type -> boltzrpc.ImportWalletRequest
	59, // 81: boltzrpc.Boltz.SetSubaccount:input_type -> boltzrpc.SetSubaccountRequest
	60, // 82: boltzrpc.Boltz.GetSubaccounts:input_type -> boltzrpc.GetSubaccountsRequest
	63, // 83: boltzrpc.Boltz.GetWallets:input_type -> boltzrpc.GetWalletsRequest
	64, // 84: boltzrpc.Boltz.GetWallet:input_type -> boltzrpc.GetWalletRequest
	65, // 85: boltzrpc.Boltz.GetWalletCredentials:input_type -> boltzrpc.GetWalletCredentialsRequest
	66, // 86: boltzrpc.Boltz.RemoveWallet:input_type -> boltzrpc.RemoveWalletRequest
	67, // 87: boltzrpc.Boltz.WalletSend:input_type -> boltzrpc.WalletSendRequest
	69, // 88: boltzrpc.Boltz.WalletReceive:input_type -> boltzrpc.WalletReceiveRequest
	80, // 89: boltzrpc.Boltz.Stop:input_type -> google.protobuf.Empty
	76, // 90: boltzrpc.Boltz.Unlock:input_type -> boltzrpc.UnlockRequest
	77, // 91: boltzrpc.Boltz.VerifyWalletPassword:input_type -> boltzrpc.VerifyWalletPasswordRequest
	79, // 92: boltzrpc.Boltz.ChangeWalletPassword:input_type -> boltzrpc.ChangeWalletPasswordRequest
	5,  // 93: boltzrpc.Boltz.CreateTenant:input_type -> boltzrpc.CreateTenantRequest
	6,  // 94: boltzrpc.Boltz.ListTenants:input_type -> boltzrpc.ListTenantsRequest
	8,  // 95: boltzrpc.Boltz.GetTenant:input_type -> boltzrpc.GetTenantRequest
	11, // 96: boltzrpc.Boltz.BakeMacaroon:input_type -> boltzrpc.BakeMacaroonRequest
	22, // 97: boltzrpc.Boltz.GetInfo:output_type -> boltzrpc.GetInfoResponse
	29, // 98: boltzrpc.Boltz.GetServiceInfo:output_type -> boltzrpc.GetServiceInfoResponse
	16, // 99: boltzrpc.Boltz.GetPairInfo:output_type -> boltzrpc.PairInfo
	25, // 100: boltzrpc.Boltz.GetPairs:output_type -> boltzrpc.GetPairsResponse
	32, // 101: boltzrpc.Boltz.ListSwaps:output_type -> boltzrpc.ListSwapsResponse
	34, // 102: boltzrpc.Boltz.GetStats:output_type -> boltzrpc.GetStatsResponse
	39, // 103: boltzrpc.Boltz.RefundSwap:output_type -> boltzrpc.GetSwapInfoResponse
	37, // 104: boltzrpc.Boltz.ClaimSwaps:output_type -> boltzrpc.ClaimSwapsResponse
	39, // 105: boltzrpc.Boltz.GetSwapInfo:output_type -> boltzrpc.GetSwapInfoResponse
	39, // 106: boltzrpc.Boltz.GetSwapInfoStream:output_type -> boltzrpc.GetSwapInfoResponse
	41, // 107: boltzrpc.Boltz.Deposit:output_type -> boltzrpc.DepositResponse
	43, // 108: boltzrpc.Boltz.CreateSwap:output_type -> boltzrpc.CreateSwapResponse
	43, // 109: boltzrpc.Boltz.CreateChannel:output_type -> boltzrpc.CreateSwapResponse
	46, // 110: boltzrpc.Boltz.CreateReverseSwap:output_type -> boltzrpc.CreateReverseSwapResponse
	48, // 111: boltzrpc.Boltz.CreateChainSwap:output_type -> boltzrpc.ChainSwapInfo
	58, // 112: boltzrpc.Boltz.CreateWallet:output_type -> boltzrpc.CreateWalletResponse
	71, // 113: boltzrpc.Boltz.ImportWallet:output_type -> boltzrpc.Wallet
	74, // 114: boltzrpc.Boltz.SetSubaccount:output_type -> boltzrpc.Subaccount
	61, // 115: boltzrpc.Boltz.GetSubaccounts:output_type -> boltzrpc.GetSubaccountsResponse
	72, // 116: boltzrpc.Boltz.GetWallets:output_type -> boltzrpc.Wallets
	71, // 117: boltzrpc.Boltz.GetWallet:output_type -> boltzrpc.Wallet
	54, // 118: boltzrpc.Boltz.GetWalletCredentials:output_type -> boltzrpc.WalletCredentials
	75, // 119: boltzrpc.Boltz.RemoveWallet:output_type -> boltzrpc.RemoveWalletResponse
	68, // 120: boltzrpc.Boltz.WalletSend:output_type -> boltzrpc.WalletSendResponse
	70, // 121: boltzrpc.Boltz.WalletReceive:output_type -> boltzrpc.WalletReceiveResponse
	80, // 122: boltzrpc.Boltz.Stop:output_type -> google.protobuf.Empty
	80, // 123: boltzrpc.Boltz.Unlock:output_type -> google.protobuf.Empty
	78, // 124: boltzrpc.Boltz.VerifyWalletPassword:output_type -> boltzrpc.VerifyWalletPasswordResponse
	80, // 125: boltzrpc.Boltz.ChangeWalletPassword:output_type -> google.protobuf.Empty
	9,  // 126: boltzrpc.Boltz.CreateTenant:output_type -> boltzrpc.Tenant
	7,  // 127: boltzrpc.Boltz.ListTenants:output_type -> boltzrpc.ListTenantsResponse
	9,  // 128: boltzrpc.Boltz.GetTenant:output_type -> boltzrpc.Tenant
	12, // 129: boltzrpc.Boltz.BakeMacaroon:output_type -> boltzrpc.BakeMacaroonResponse
