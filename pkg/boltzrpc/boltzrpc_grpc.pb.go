...
const (
	...
	Boltz_ClaimFundingAddress_FullMethodName     = "/boltzrpc.Boltz/ClaimFundingAddress"
)
...
type BoltzClient interface {
	...
	// Claims a funding address by cooperatively signing with Boltz to move funds to a destination address or wallet.
	// This can be used to recover funds from a funding address that hasn't been used for a swap.
	ClaimFundingAddress(ctx context.Context, in *ClaimFundingAddressRequest, opts ...grpc.CallOption) (*ClaimFundingAddressResponse, error)
}
...
func (c *boltzClient) GetWalletSendFee(ctx context.Context, in *WalletSendRequest, opts ...grpc.CallOption) (*WalletSendFee, error) {
	out := new(WalletSendFee)
	err := c.cc.Invoke(ctx, Boltz_GetWalletSendFee_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *boltzClient) BumpTransaction(ctx context.Context, in *BumpTransactionRequest, opts ...grpc.CallOption) (*BumpTransactionResponse, error) {
	out := new(BumpTransactionResponse)
	err := c.cc.Invoke(ctx, Boltz_BumpTransaction_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *boltzClient) RemoveTenant(ctx context.Context, in *RemoveTenantRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Boltz_RemoveTenant_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *boltzClient) ClaimFundingAddress(ctx context.Context, in *ClaimFundingAddressRequest, opts ...grpc.CallOption) (*ClaimFundingAddressResponse, error) {
	out := new(ClaimFundingAddressResponse)
	err := c.cc.Invoke(ctx, Boltz_ClaimFundingAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BoltzServer interface {
	...
	// Claims a funding address by cooperatively signing with Boltz to move funds to a destination address or wallet.
	// This can be used to recover funds from a funding address that hasn't been used for a swap.
	ClaimFundingAddress(context.Context, *ClaimFundingAddressRequest) (*ClaimFundingAddressResponse, error)
...
func (UnimplementedBoltzServer) GetWalletSendFee(context.Context, *WalletSendRequest) (*WalletSendFee, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWalletSendFee not implemented")
}
...
func (UnimplementedBoltzServer) BumpTransaction(context.Context, *BumpTransactionRequest) (*BumpTransactionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BumpTransaction not implemented")
}
...
func (UnimplementedBoltzServer) RemoveTenant(context.Context, *RemoveTenantRequest) (*emptypb.Empty, error) {
...
func (UnimplementedBoltzServer) ClaimFundingAddress(context.Context, *ClaimFundingAddressRequest) (*ClaimFundingAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ClaimFundingAddress not implemented")
}
...
func _Boltz_GetWalletSendFee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WalletSendRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoltzServer).GetWalletSendFee(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Boltz_GetWalletSendFee_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoltzServer).GetWalletSendFee(ctx, req.(*WalletSendRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Boltz_BumpTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BumpTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoltzServer).BumpTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Boltz_BumpTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoltzServer).BumpTransaction(ctx, req.(*BumpTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Boltz_RemoveTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveTenantRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoltzServer).RemoveTenant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Boltz_RemoveTenant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoltzServer).RemoveTenant(ctx, req.(*RemoveTenantRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Boltz_ClaimFundingAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClaimFundingAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoltzServer).ClaimFundingAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Boltz_ClaimFundingAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoltzServer).ClaimFundingAddress(ctx, req.(*ClaimFundingAddressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Boltz_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Boltz_BumpTransaction_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Boltz_RemoveTenant_Handler,
		},
		{
		...
		{
			MethodName: "ClaimFundingAddress",
			Handler:    _Boltz_ClaimFundingAddress_Handler,
		},
	},
