...
const (
	...
	Boltz_Restore_FullMethodName                 = "/boltzrpc.Boltz/Restore"
...
type BoltzClient interface {
	...
	// Restores funding addresses from Boltz using the provided mnemonic.
	// Re-creates the funding address database entries and returns them in the standard schema.
...
func (c *boltzClient) Restore(ctx context.Context, in *RestoreRequest, opts ...grpc.CallOption) (*RestoreResponse, error) {
	out := new(RestoreResponse)
	err := c.cc.Invoke(ctx, Boltz_Restore_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBoltzServer) Restore(context.Context, *RestoreRequest) (*RestoreResponse, error) {
...
func _Boltz_Restore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RestoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BoltzServer).Restore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Boltz_Restore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoltzServer).Restore(ctx, req.(*RestoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Boltz_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Restore",
			Handler:    _Boltz_Restore_Handler,
		},
		{
