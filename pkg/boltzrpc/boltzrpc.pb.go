...
var file_boltzrpc_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x73, 0x22, 0x6a, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	...
	0x10, 0x04, 0x32, 0xd6, 0x14, 0x0a, 0x05, 0x42, 0x6f, 0x6c, 0x74, 0x7a, 0x12, 0x3e, 0x0a, 0x07,
	...
	0x6f, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x37, 0x5a, 0x35, 0x67,
...
var file_boltzrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 81)
var file_boltzrpc_proto_goTypes = []interface{}{
	...
	(*TransactionInfo)(nil),                // 69: boltzrpc.TransactionInfo
	(*TransactionOutput)(nil),              // 70: boltzrpc.TransactionOutput
	(*ListWalletTransactionsResponse)(nil), // 71: boltzrpc.ListWalletTransactionsResponse
	(*GetWalletCredentialsRequest)(nil),    // 72: boltzrpc.GetWalletCredentialsRequest
	(*RemoveWalletRequest)(nil),            // 73: boltzrpc.RemoveWalletRequest
	(*WalletSendRequest)(nil),              // 74: boltzrpc.WalletSendRequest
	(*WalletSendResponse)(nil),             // 75: boltzrpc.WalletSendResponse
	(*WalletReceiveRequest)(nil),           // 76: boltzrpc.WalletReceiveRequest
	(*WalletReceiveResponse)(nil),          // 77: boltzrpc.WalletReceiveResponse
	(*Wallet)(nil),                         // 78: boltzrpc.Wallet
	(*Wallets)(nil),                        // 79: boltzrpc.Wallets
	(*Balance)(nil),                        // 80: boltzrpc.Balance
	(*Subaccount)(nil),                     // 81: boltzrpc.Subaccount
	(*RemoveWalletResponse)(nil),           // 82: boltzrpc.RemoveWalletResponse
	(*UnlockRequest)(nil),                  // 83: boltzrpc.UnlockRequest
	(*VerifyWalletPasswordRequest)(nil),    // 84: boltzrpc.VerifyWalletPasswordRequest
	(*VerifyWalletPasswordResponse)(nil),   // 85: boltzrpc.VerifyWalletPasswordResponse
	(*ChangeWalletPasswordRequest)(nil),    // 86: boltzrpc.ChangeWalletPasswordRequest
...
var file_boltzrpc_proto_depIdxs = []int32{
	...
	78,  // 60: boltzrpc.CreateWalletResponse.wallet:type_name -> boltzrpc.Wallet
	81,  // 61: boltzrpc.GetSubaccountsResponse.subaccounts:type_name -> boltzrpc.Subaccount
	2,   // 62: boltzrpc.GetWalletsRequest.currency:type_name -> boltzrpc.Currency
	70,  // 63: boltzrpc.WalletTransaction.outputs:type_name -> boltzrpc.TransactionOutput
	69,  // 64: boltzrpc.WalletTransaction.infos:type_name -> boltzrpc.TransactionInfo
	...
	80,  // 68: boltzrpc.Wallet.balance:type_name -> boltzrpc.Balance
	78,  // 69: boltzrpc.Wallets.wallets:type_name -> boltzrpc.Wallet
	80,  // 70: boltzrpc.Subaccount.balance:type_name -> boltzrpc.Balance
	...
	87,  // 74: boltzrpc.Boltz.GetPairs:input_type -> google.protobuf.Empty
	...
	74,  // 92: boltzrpc.Boltz.GetWalletSendFee:input_type -> boltzrpc.WalletSendRequest
	67,  // 93: boltzrpc.Boltz.ListWalletTransactions:input_type -> boltzrpc.ListWalletTransactionsRequest
	72,  // 94: boltzrpc.Boltz.GetWalletCredentials:input_type -> boltzrpc.GetWalletCredentialsRequest
	73,  // 95: boltzrpc.Boltz.RemoveWallet:input_type -> boltzrpc.RemoveWalletRequest
	74,  // 96: boltzrpc.Boltz.WalletSend:input_type -> boltzrpc.WalletSendRequest
	76,  // 97: boltzrpc.Boltz.WalletReceive:input_type -> boltzrpc.WalletReceiveRequest
	87,  // 98: boltzrpc.Boltz.Stop:input_type -> google.protobuf.Empty
	83,  // 99: boltzrpc.Boltz.Unlock:input_type -> boltzrpc.UnlockRequest
	84,  // 100: boltzrpc.Boltz.VerifyWalletPassword:input_type -> boltzrpc.VerifyWalletPasswordRequest
	86,  // 101: boltzrpc.Boltz.ChangeWalletPassword:input_type -> boltzrpc.ChangeWalletPasswordRequest
	6,   // 102: boltzrpc.Boltz.CreateTenant:input_type -> boltzrpc.CreateTenantRequest
	7,   // 103: boltzrpc.Boltz.ListTenants:input_type -> boltzrpc.ListTenantsRequest
	9,   // 104: boltzrpc.Boltz.GetTenant:input_type -> boltzrpc.GetTenantRequest
	12,  // 105: boltzrpc.Boltz.BakeMacaroon:input_type -> boltzrpc.BakeMacaroonRequest
	23,  // 106: boltzrpc.Boltz.GetInfo:output_type -> boltzrpc.GetInfoResponse
	30,  // 107: boltzrpc.Boltz.GetServiceInfo:output_type -> boltzrpc.GetServiceInfoResponse
	17,  // 108: boltzrpc.Boltz.GetPairInfo:output_type -> boltzrpc.PairInfo
	26,  // 109: boltzrpc.Boltz.GetPairs:output_type -> boltzrpc.GetPairsResponse
	33,  // 110: boltzrpc.Boltz.ListSwaps:output_type -> boltzrpc.ListSwapsResponse
	35,  // 111: boltzrpc.Boltz.GetStats:output_type -> boltzrpc.GetStatsResponse
	40,  // 112: boltzrpc.Boltz.RefundSwap:output_type -> boltzrpc.GetSwapInfoResponse
	38,  // 113: boltzrpc.Boltz.ClaimSwaps:output_type -> boltzrpc.ClaimSwapsResponse
	40,  // 114: boltzrpc.Boltz.GetSwapInfo:output_type -> boltzrpc.GetSwapInfoResponse
	40,  // 115: boltzrpc.Boltz.GetSwapInfoStream:output_type -> boltzrpc.GetSwapInfoResponse
	42,  // 116: boltzrpc.Boltz.Deposit:output_type -> boltzrpc.DepositResponse
	44,  // 117: boltzrpc.Boltz.CreateSwap:output_type -> boltzrpc.CreateSwapResponse
	44,  // 118: boltzrpc.Boltz.CreateChannel:output_type -> boltzrpc.CreateSwapResponse
	47,  // 119: boltzrpc.Boltz.CreateReverseSwap:output_type -> boltzrpc.CreateReverseSwapResponse
	49,  // 120: boltzrpc.Boltz.CreateChainSwap:output_type -> boltzrpc.ChainSwapInfo
	59,  // 121: boltzrpc.Boltz.CreateWallet:output_type -> boltzrpc.CreateWalletResponse
	78,  // 122: boltzrpc.Boltz.ImportWallet:output_type -> boltzrpc.Wallet
	81,  // 123: boltzrpc.Boltz.SetSubaccount:output_type -> boltzrpc.Subaccount
	62,  // 124: boltzrpc.Boltz.GetSubaccounts:output_type -> boltzrpc.GetSubaccountsResponse
	79,  // 125: boltzrpc.Boltz.GetWallets:output_type -> boltzrpc.Wallets
	78,  // 126: boltzrpc.Boltz.GetWallet:output_type -> boltzrpc.Wallet
	66,  // 127: boltzrpc.Boltz.GetWalletSendFee:output_type -> boltzrpc.WalletSendFee
	71,  // 128: boltzrpc.Boltz.ListWalletTransactions:output_type -> boltzrpc.ListWalletTransactionsResponse
	55,  // 129: boltzrpc.Boltz.GetWalletCredentials:output_type -> boltzrpc.WalletCredentials
	82,  // 130: boltzrpc.Boltz.RemoveWallet:output_type -> boltzrpc.RemoveWalletResponse
	75,  // 131: boltzrpc.Boltz.WalletSend:output_type -> boltzrpc.WalletSendResponse
	77,  // 132: boltzrpc.Boltz.WalletReceive:output_type -> boltzrpc.WalletReceiveResponse
	87,  // 133: boltzrpc.Boltz.Stop:output_type -> google.protobuf.Empty
	87,  // 134: boltzrpc.Boltz.Unlock:output_type -> google.protobuf.Empty
	85,  // 135: boltzrpc.Boltz.VerifyWalletPassword:output_type -> boltzrpc.VerifyWalletPasswordResponse
	87,  // 136: boltzrpc.Boltz.ChangeWalletPassword:output_type -> google.protobuf.Empty
	10,  // 137: boltzrpc.Boltz.CreateTenant:output_type -> boltzrpc.Tenant
	8,   // 138: boltzrpc.Boltz.ListTenants:output_type -> boltzrpc.ListTenantsResponse
	10,  // 139: boltzrpc.Boltz.GetTenant:output_type -> boltzrpc.Tenant
	13,  // 140: boltzrpc.Boltz.BakeMacaroon:output_type -> boltzrpc.BakeMacaroonResponse
