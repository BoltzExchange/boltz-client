...
func (boltz *Boltz) ClaimFundingAddress(request *boltzrpc.ClaimFundingAddressRequest) (*boltzrpc.ClaimFundingAddressResponse, error) {
	return boltz.Client.ClaimFundingAddress(boltz.Ctx, request)
}
